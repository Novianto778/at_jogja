...
const Stories = () => {
  return (
    <section className="container py-10" id="stories">
              ...
              <div className="h-full min-h-[300px]">
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-start justify-end p-6 gap-2">
                    ...
                    <p className="text-white text-body line-clamp-2">
                      From savory satay to sweet treats, discover the flavors
                      that make Yogyakarta a food lover's paradise.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative w-full h-full rounded-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-start justify-end p-6 gap-2">
                    ...
                    <p className="text-white text-body line-clamp-2">
                      ...
                      traditional customs, and the Sultan's role as the
                      spiritual and cultural leader of Yogyakarta.
                    </p>
                  </div>
                </div>
              </div>
