        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
          <div class="block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <h2 class="mt-2 mb-2  font-bold">Adi Nugroho</h2>
              <p class="text-sm">
                Selamat datang! My name is Adi, and I'm your friendly
                neighborhood tour guide with a passion for adventure and
                exploration. Born and raised in Sleman, I have a deep connection
                with the natural beauty of Yogyakarta and love taking travelers
                off the beaten path to discover hidden waterfalls, caves, and
                hiking trails. Let's embark on an unforgettable adventure
                together!
              </p>
              <div class="mt-3 flex items-center">
                <span class="text-sm font-semibold">start form</span>&nbsp;
                <span class="font-bold text-xl">Rp 200.000</span>
              </div>
            </div>
            <div class="p-4 flex flex-col gap-4 border-t border-b text-xs text-gray-700">
              <p className="text-sm">
                <span className="font-semibold">Tour Specialization:</span>{" "}
                Adventure Tours, Nature Tours
              </p>
              <p className="text-sm">
            ...
            <div className="flex items-center justify-between p-4">
              <div class="flex items-center text-sm text-gray-600">
                <Star
                  ...
                  fill="rgb(249,11,22)"
                />
                <span class="ml-2">3 Reviews</span>
              </div>
          ...
          <div class="block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <h2 class="mt-2 mb-2  font-bold">Ika Susanto</h2>
              <p class="text-sm">
                Hi, I'm Ika, a passionate tour guide born and raised in
                Yogyakarta. With over 5 years of experience in guiding tourists,
                I specialize in cultural and heritage tours, offering in-depth
                knowledge about the rich history and traditions of Java. I am
                fluent in English and Javanese and love sharing stories about
                the hidden gems and local legends of Yogyakarta.
              </p>
              <div class="mt-3 flex items-center">
                <span class="text-sm font-semibold">start form</span>&nbsp;
                <span class="font-bold text-xl">Rp 250.000</span>
              </div>
            </div>
            <div class="p-4 flex flex-col gap-4 border-t border-b text-xs text-gray-700">
              <p className="text-sm">
          ...
          <div class="block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <h2 class="mt-2 mb-2  font-bold">Siti Rahayu</h2>
              <p class="text-sm">
                Halo! I'm Siti, a seasoned tour guide with a knack for culinary
                delights and local delicacies. Growing up in Yogyakarta, I've
                developed a deep appreciation for the diverse flavors and tastes
                of Javanese cuisine. Join me on a culinary journey through
                bustling markets and street food stalls to sample authentic
                dishes and discover the secrets of Javanese cooking. Selamat
                makan!
              </p>
              <div class="mt-3 flex items-center">
                <span class="text-sm font-semibold">start form</span>&nbsp;
